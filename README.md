...
pod 'PEPNetworking_BD', :git => 'https://github.com/PEPDigitalPublishing/PEPNetworking_BD.git'

pod 'PEPBigData', :git => 'https://github.com/PEPDigitalPublishing/PEPBigData.git'

pod 'PEPReaderSDK_BD', :git => 'https://github.com/PEPDigitalPublishing/PEPReaderSDK_BD.git'
